...
3. comitter.sh, sophisitcates intermedatiate results from the analyzer and looks for key-pairs. There lies additional responsibility for this in the future. 
